import{g as b,h as P,i as D,j as R,t as I,u as A,k as N,_ as E,o as u,c as p,l as _,v as O,a as m,n as S,m as y,F as x,p as G,e as k,q as w,s as F}from"./app.e37374cb.js";const B=[{path:"/",title:"MicroCity笔记",pathLocale:"/",contents:[{header:"MicroCity笔记",slug:"microcity笔记",content:`目前正在施工中🧱...
MicroCity文档：搜索及部分解释
...
4.7 Discrete Event Simulations > | Table of Contents`}]},{path:"/docs/",title:"MicroCity文档",pathLocale:"/",contents:[{header:"MicroCity文档",slug:"microcity文档",content:""},{header:"目录",slug:"目录",content:`1 Introduction 介绍 1.1 What MicroCity can Do MicroCity能干什么 2 Getting Started 开始使用 2.1 Showing a World Map 展示世界地图
