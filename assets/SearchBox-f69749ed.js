...
obj:delete()`}]},{path:"/notes/3d-objects.html",title:"3D 对象",pathLocale:"/",contents:[{header:"3D 对象",slug:"_3d-对象",content:"本节将介绍三维场景的对象及其控制函数。"},{header:"添加对象",slug:"添加对象",content:`向场景中添加对象，函数形式如下
...
Afterward, you can proceed with the general process 😎`}]},{path:"/notes/mip.html",title:"混合整数规划",pathLocale:"/",contents:[{header:"混合整数规划",slug:"混合整数规划",content:""},{header:"创建混合整数规划模型",slug:"创建混合整数规划模型",content:`创建整数规划模型对象
...
x2= 2.0
x3= 1.0 在线运行
在MicroCityWeb中查看这个示例`},{header:"建模的一些技巧",slug:"建模的一些技巧",content:""},{header:"线性化",slug:"线性化",content:`有时候我们会遇到多下标的建模问题，如决策变量为xijx_{ij}xij​，这个时候就要将其进行线性化编码。
假设决策变量本身的形状共有3行4列，即： 列1
列2
列3
列4 x11x_{11}x11​
