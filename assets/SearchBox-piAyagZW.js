import{f as b,g as j,h as L,i as _,t as I,u as D,j as O,_ as z,o as u,c as p,k as N,v as R,a as f,n as y,l as x,F as T,m as M,p as G,q as w,s as E}from"./app-Q07NRad_.js";const F=[{path:"/",title:"首页",pathLocale:"/",contents:[{header:"开始使用MicroCity Web",slug:"开始使用microcity-web",content:`打开MicroCity Web，默认加载方块旋转的示例代码。 点击运行按钮运行代码 程序运行，看到右侧视图中方块旋转。 更多MicroCity的使用方法可以参考本站翻译的 MicroCity Web中文文档。
