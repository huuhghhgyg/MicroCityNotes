import{u as j}from"./app-3410d2c5.js";import{r as m,h as C,z as A,c as I,U as N,u as R,_ as E,p as u,q as p,a0 as _,ad as O,S as b,w as S,a5 as y,P as x,Q as v,R as M,v as w,ae as F}from"./framework-9fc6aeb2.js";const B=[{path:"/",title:"首页",pathLocale:"/",contents:[{header:"开始使用MicroCity",slug:"开始使用microcity",content:'转到MicroCity的文档仓库下载 MicroCity的最新版本 打开 ScriptEditor 并输入: Print("hello, world!") 将脚本另存为 test.mcs 并将其拖入 MicroCity 在程序主界面左侧转到 Modules 标签页，打开 test ，双击其中的 main ，执行刚刚编写的脚本。 程序界面下方的 Messages 栏中会输出执行脚本的信息。 更多MicroCity的使用方法可以参考本站搬运自GitHub的文档：MicroCity文档，也可以参考 MicroCtiy 在GitHub上的文档。'},{header:"MicroCityNotes 仓库",slug:"microcitynotes-仓库",content:`目前正在施工阶段🧱...
...
如果需要更改属性值，只接受数值(Number)、字符串(String)、对象(Object)三种类型 SetParameter()函数的介绍出现在文档 4.2 控制用户界面 中，请参阅。`}]},{path:"/docs/imgs/",title:"",pathLocale:"/",contents:[{header:"",slug:"",content:"This folder contains images used by documentation pages."}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],z="update-vuepress-plugin-full-text-search2-search-index";var k=m(B),U=C(()=>{const e=new Map;for(const t of k.value)e.set(t.path,t);return e});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[z]=e=>{k.value=e});function Y(e){const t=m([]);let s=null;return A(e,()=>{s&&clearTimeout(s),s=setTimeout(o,100)}),t;function o(){const d=e.value.toLowerCase().trim();if(!d){t.value=[];return}const i=new Map,n=new Set;for(const a of k.value)for(const r of V(a,d)){n.add(r.parentPageTitle);let l=i.get(r.parentPageTitle);l||(l=[],i.set(r.parentPageTitle,l)),l.push(r)}const c=[...n].sort((a,r)=>{const l=i.get(a);return i.get(r).length-l.length});t.value=[...i].flatMap(([,a])=>a).sort((a,r)=>a.parentPagePriority-r.parentPagePriority||c.indexOf(a.parentPageTitle)-c.indexOf(r.parentPageTitle)||a.priority-r.priority)}}function*V(e,t){const s=T(e.title,t);if(s){yield{path:e.path,parentPageTitle:P(e),title:e.title,display:s,page:e,content:null,parentPagePriority:1,priority:1};return}for(const o of e.contents){const d=T(o.header,t);if(d){yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:P(e),title:e.title,display:d,page:e,content:null,parentPagePriority:10,priority:2};continue}const i=T(o.content,t);i&&(yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:P(e),title:e.title,display:[{type:"header",str:`${o.header}
`},...i],page:e,content:null,parentPagePriority:10,priority:10})}}function P(e){const t=e.path.split("/");let s="/";return t[1]&&(s=`/${t[1]}/`),(U.value.get(s)||e).title}function T(e,t){const s=[];let o=0;const d=e.toLowerCase().replace(/\s/gu," ");let i=0,n=d.indexOf(t,i);if(n<0)return null;for(;n>=0;){const a=n+t.length;if(c(e.slice(i,n),"normal"),c(e.slice(n,a),"highlight"),i=a,n=d.indexOf(t,i),o>100)break}return c(e.slice(i),"normal"),s.filter(a=>a.str);function c(a,r){let l=a;r==="normal"&&l.length>100&&o===0&&(l=`… ${l.slice(-10)}`);let f=!1;if(o+l.length>100){if(s.some(g=>g.type==="ellipsis"))return;l=l.slice(0,Math.max(100-o,1)),f=!0}s.push({type:r,str:l}),o+=l.length,f&&(s.push({type:"ellipsis",str:" …"}),o+=2)}}const X={"/":{placeholder:"搜索"}},W=I({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>X}},setup(e){const{locales:t}=N(e),s=m(""),o=m(!1),d=m(-1),i=Y(s),n=C(()=>s.value&&o.value&&i.value.length),c=R(),a=j(),r=C(()=>t.value[a.value]??{});function l(){if(!n.value)return;let h=d.value-1;h<0&&(h=i.value.length-1),g(h)}function f(){if(!n.value)return;let h=d.value+1;h>=i.value.length&&(h=0),g(h)}function g(h){d.value=h}function G(){d.value=-1}function D(h){if(!n.value)return;const L=i.value[h];L&&c.push(L.path)}return{query:s,focused:o,focusIndex:d,suggestions:i,activeSuggestion:n,onUp:l,onDown:f,focus:g,unfocus:G,go:D,locale:r}}});const q={class:"search-box",role:"search"},$=["placeholder"],H=["onMousedown","onMouseenter"],Q=["href"],Z={key:0,class:"parent-page-title"},J={class:"suggestion-row"},K={class:"page-title"},ee={class:"suggestion-content"};function te(e,t,s,o,d,i){return u(),p("div",q,[_(b("input",{ref:"input","onUpdate:modelValue":t[0]||(t[0]=n=>e.query=n),"aria-label":"Search",class:S({focused:e.focused}),placeholder:e.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:t[1]||(t[1]=()=>e.focused=!0),onBlur:t[2]||(t[2]=()=>e.focused=!1),onKeyup:[t[3]||(t[3]=y(n=>e.go(e.focusIndex),["enter"])),t[4]||(t[4]=y((...n)=>e.onUp&&e.onUp(...n),["up"])),t[5]||(t[5]=y((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,$),[[O,e.query]]),e.activeSuggestion?(u(),p("ul",{key:0,class:"suggestions",onMouseleave:t[7]||(t[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(u(!0),p(x,null,v(e.suggestions,(n,c)=>(u(),p("li",{key:c,class:S(["suggestion",{focused:c===e.focusIndex}]),onMousedown:a=>e.go(c),onMouseenter:a=>e.focus(c)},[b("a",{href:n.path,onClick:t[6]||(t[6]=F(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[c-1]||e.suggestions[c-1].parentPageTitle!==n.parentPageTitle)?(u(),p("div",Z,w(n.parentPageTitle),1)):M("v-if",!0),b("div",J,[b("div",K,w(n.title||n.path),1),b("div",ee,[(u(!0),p(x,null,v(n.display,(a,r)=>(u(),p("span",{key:r,class:S(a.type)},w(a.str),3))),128))])])],8,Q)],42,H))),128))],32)):M("v-if",!0)])}const oe=E(W,[["render",te],["__scopeId","data-v-fd6cd4d5"],["__file","SearchBox.vue"]]);export{oe as default};
