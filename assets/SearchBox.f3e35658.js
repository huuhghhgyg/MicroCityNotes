import{g as m,h as C,i as j,j as A,t as I,u as N,k as R,_ as E,o as u,c as p,l as _,v as O,a as b,n as S,m as y,F as x,p as v,f as M,q as w,s as F}from"./app.1e6d3545.js";const B=[{path:"/",title:"首页",pathLocale:"/",contents:[{header:"开始使用MicroCity",slug:"开始使用microcity",content:'转到MicroCity的文档仓库下载 MicroCity的最新版本 打开 ScriptEditor 并输入: Print("hello, world!") 将脚本另存为 test.mcs 并将其拖入 MicroCity 在程序主界面左侧转到 Modules 标签页，打开 test ，双击其中的 main ，执行刚刚编写的脚本。 程序界面下方的 Messages 栏中会输出执行脚本的信息。 更多MicroCity的使用方法可以参考本站搬运自GitHub的文档：MicroCity文档，也可以参考 MicroCtiy 在GitHub上的文档。'},{header:"MicroCityNotes 仓库",slug:"microcitynotes-仓库",content:`目前正在施工阶段🧱...
...
-- 4, 3
-- 2, 2
-- 5, 1`},{header:"table的引用",slug:"table的引用",content:`当没有对table进行对拷，而直接复制的时候，你新的到的table相当于原table的引用，称为浅拷贝。当你修改浅拷贝得到的table中的元素时，由于两个table是引用的关系，原table中的元素也会随之改变。
...
如果需要更改属性值，只接受数值(Number)、字符串(String)、对象(Object)三种类型 SetParameter()函数的介绍出现在文档 4.2 控制用户界面 中，请参阅。`}]},{path:"/docs/imgs/",title:"",pathLocale:"/",contents:[{header:"",slug:"",content:"This folder contains images used by documentation pages."}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],z="update-vuepress-plugin-full-text-search2-search-index";var k=m(B),U=C(()=>{const e=new Map;for(const t of k.value)e.set(t.path,t);return e});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[z]=e=>{k.value=e});function Y(e){const t=m([]);let r=null;return j(e,()=>{r&&clearTimeout(r),r=setTimeout(o,100)}),t;function o(){const c=e.value.toLowerCase().trim();if(!c){t.value=[];return}const i=new Map,d=new Set;for(const a of k.value)for(const s of V(a,c)){d.add(s.parentPageTitle);let l=i.get(s.parentPageTitle);l||(l=[],i.set(s.parentPageTitle,l)),l.push(s)}const n=[...d].sort((a,s)=>{const l=i.get(a);return i.get(s).length-l.length});t.value=[...i].flatMap(([,a])=>a).sort((a,s)=>a.parentPagePriority-s.parentPagePriority||n.indexOf(a.parentPageTitle)-n.indexOf(s.parentPageTitle)||a.priority-s.priority)}}function*V(e,t){const r=T(e.title,t);if(r){yield{path:e.path,parentPageTitle:P(e),title:e.title,display:r,page:e,content:null,parentPagePriority:1,priority:1};return}for(const o of e.contents){const c=T(o.header,t);if(c){yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:P(e),title:e.title,display:c,page:e,content:null,parentPagePriority:10,priority:2};continue}const i=T(o.content,t);i&&(yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:P(e),title:e.title,display:[{type:"header",str:`${o.header}
`},...i],page:e,content:null,parentPagePriority:10,priority:10})}}function P(e){const t=e.path.split("/");let r="/";return t[1]&&(r=`/${t[1]}/`),(U.value.get(r)||e).title}function T(e,t){const r=[];let o=0;const c=e.toLowerCase().replace(/\s/gu," ");let i=0,d=c.indexOf(t,i);if(d<0)return null;for(;d>=0;){const a=d+t.length;if(n(e.slice(i,d),"normal"),n(e.slice(d,a),"highlight"),i=a,d=c.indexOf(t,i),o>100)break}return n(e.slice(i),"normal"),r.filter(a=>a.str);function n(a,s){let l=a;s==="normal"&&l.length>100&&o===0&&(l=`… ${l.slice(-10)}`);let f=!1;if(o+l.length>100){if(r.some(g=>g.type==="ellipsis"))return;l=l.slice(0,Math.max(100-o,1)),f=!0}r.push({type:s,str:l}),o+=l.length,f&&(r.push({type:"ellipsis",str:" …"}),o+=2)}}const X={"/":{placeholder:"搜索"}},W=A({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>X}},setup(e){const{locales:t}=I(e),r=m(""),o=m(!1),c=m(-1),i=Y(r),d=C(()=>r.value&&o.value&&i.value.length),n=N(),a=R(),s=C(()=>{var h;return(h=t.value[a.value])!=null?h:{}});function l(){if(!d.value)return;let h=c.value-1;h<0&&(h=i.value.length-1),g(h)}function f(){if(!d.value)return;let h=c.value+1;h>=i.value.length&&(h=0),g(h)}function g(h){c.value=h}function G(){c.value=-1}function D(h){if(!d.value)return;const L=i.value[h];L&&n.push(L.path)}return{query:r,focused:o,focusIndex:c,suggestions:i,activeSuggestion:d,onUp:l,onDown:f,focus:g,unfocus:G,go:D,locale:s}}});const q={class:"search-box",role:"search"},$=["placeholder"],H=["onMousedown","onMouseenter"],Z=["href"],Q={key:0,class:"parent-page-title"},J={class:"suggestion-row"},K={class:"page-title"},ee={class:"suggestion-content"};function te(e,t,r,o,c,i){var d;return u(),p("div",q,[_(b("input",{ref:"input","onUpdate:modelValue":t[0]||(t[0]=n=>e.query=n),"aria-label":"Search",class:S({focused:e.focused}),placeholder:(d=e.locale.placeholder)!=null?d:"Search",autocomplete:"off",spellcheck:"false",onFocus:t[1]||(t[1]=()=>e.focused=!0),onBlur:t[2]||(t[2]=()=>e.focused=!1),onKeyup:[t[3]||(t[3]=y(n=>e.go(e.focusIndex),["enter"])),t[4]||(t[4]=y((...n)=>e.onUp&&e.onUp(...n),["up"])),t[5]||(t[5]=y((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,$),[[O,e.query]]),e.activeSuggestion?(u(),p("ul",{key:0,class:"suggestions",onMouseleave:t[7]||(t[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(u(!0),p(x,null,v(e.suggestions,(n,a)=>(u(),p("li",{key:a,class:S(["suggestion",{focused:a===e.focusIndex}]),onMousedown:s=>e.go(a),onMouseenter:s=>e.focus(a)},[b("a",{href:n.path,onClick:t[6]||(t[6]=F(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[a-1]||e.suggestions[a-1].parentPageTitle!==n.parentPageTitle)?(u(),p("div",Q,w(n.parentPageTitle),1)):M("v-if",!0),b("div",J,[b("div",K,w(n.title||n.path),1),b("div",ee,[(u(!0),p(x,null,v(n.display,(s,l)=>(u(),p("span",{key:l,class:S(s.type)},w(s.str),3))),128))])])],8,Z)],42,H))),128))],32)):M("v-if",!0)])}const ae=E(W,[["render",te],["__scopeId","data-v-fd6cd4d5"],["__file","SearchBox.vue"]]);export{ae as default};
