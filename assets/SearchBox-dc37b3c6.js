...
fdisp = function(v) return (v/n*100).."%" end，将数据标签改为按照比例显示（假设n为样本数）`},{header:"直方图高级用法",slug:"直方图高级用法",content:"动态刷新数据图 修改图中的数据。此处以向图中添加数据为例。其中假设rnd为添加的数据。也可以直接修改histplot.data的值。 table.insert(histplot.data, rnd) 刷新图 plot:refresh()"},{header:"示例",slug:"示例",content:""},{header:"基本用法示例：绘制泊松分布",slug:"基本用法示例-绘制泊松分布",content:`require("Histogram") --引用直方图 local seed = math.randomseed(1, { distribution = "poisson", mu = "3"
})
