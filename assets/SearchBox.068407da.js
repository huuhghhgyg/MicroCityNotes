import{g as b,h as C,i as j,j as A,t as I,u as N,k as R,_ as E,o as u,c as p,l as _,v as O,a as m,n as S,m as y,F as v,p as M,f as L,q as w,s as F}from"./app.e5db67fa.js";const B=[{path:"/",title:"首页",pathLocale:"/",contents:[{header:"开始使用MicroCity",slug:"开始使用microcity",content:'转到MicroCity的文档仓库下载 MicroCity的最新版本 打开 ScriptEditor 并输入: Print("hello, world!") 将脚本另存为 test.mcs 并将其拖入 MicroCity 在程序主界面左侧转到 Modules 标签页，打开 test ，双击其中的 main ，执行刚刚编写的脚本。 程序界面下方的 Messages 栏中会输出执行脚本的信息。 更多MicroCity的使用方法可以参考本站搬运自GitHub的文档：MicroCity文档，也可以参考 MicroCtiy 在GitHub上的文档。'},{header:"MicroCityNotes 仓库",slug:"microcitynotes-仓库",content:`目前正在施工阶段🧱...
...
这样就能返回所有点或线的索引序列了。`},{header:"避坑：序列",slug:"避坑-序列",content:`在LUA语言快速上手中介绍过LUA中的集合，它提供了丰富的特性帮助编写代码。但是没有听说过序列。序列是下面这个东西：
...
如果需要更改属性值，只接受数值(Number)、字符串(String)、对象(Object)三种类型 SetParameter()函数的介绍出现在文档 4.2 控制用户界面 中，请参阅。`}]},{path:"/docs/imgs/",title:"",pathLocale:"/",contents:[{header:"",slug:"",content:"This folder contains images used by documentation pages."}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],z="update-vuepress-plugin-full-text-search2-search-index";var k=b(B),U=C(()=>{const e=new Map;for(const t of k.value)e.set(t.path,t);return e});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[z]=e=>{k.value=e});function Y(e){const t=b([]);let r=null;return j(e,()=>{r&&clearTimeout(r),r=setTimeout(o,100)}),t;function o(){const c=e.value.toLowerCase().trim();if(!c){t.value=[];return}const i=new Map,l=new Set;for(const a of k.value)for(const s of V(a,c)){l.add(s.parentPageTitle);let d=i.get(s.parentPageTitle);d||(d=[],i.set(s.parentPageTitle,d)),d.push(s)}const n=[...l].sort((a,s)=>{const d=i.get(a);return i.get(s).length-d.length});t.value=[...i].flatMap(([,a])=>a).sort((a,s)=>a.parentPagePriority-s.parentPagePriority||n.indexOf(a.parentPageTitle)-n.indexOf(s.parentPageTitle)||a.priority-s.priority)}}function*V(e,t){const r=P(e.title,t);if(r){yield{path:e.path,parentPageTitle:T(e),title:e.title,display:r,page:e,content:null,parentPagePriority:1,priority:1};return}for(const o of e.contents){const c=P(o.header,t);if(c){yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:T(e),title:e.title,display:c,page:e,content:null,parentPagePriority:10,priority:2};continue}const i=P(o.content,t);i&&(yield{path:e.path+(o.slug?`#${o.slug}`:""),parentPageTitle:T(e),title:e.title,display:[{type:"header",str:`${o.header}
`},...i],page:e,content:null,parentPagePriority:10,priority:10})}}function T(e){const t=e.path.split("/");let r="/";return t[1]&&(r=`/${t[1]}/`),(U.value.get(r)||e).title}function P(e,t){const r=[];let o=0;const c=e.toLowerCase().replace(/\s/gu," ");let i=0,l=c.indexOf(t,i);if(l<0)return null;for(;l>=0;){const a=l+t.length;if(n(e.slice(i,l),"normal"),n(e.slice(l,a),"highlight"),i=a,l=c.indexOf(t,i),o>100)break}return n(e.slice(i),"normal"),r.filter(a=>a.str);function n(a,s){let d=a;s==="normal"&&d.length>100&&o===0&&(d=`… ${d.slice(-10)}`);let g=!1;if(o+d.length>100){if(r.some(f=>f.type==="ellipsis"))return;d=d.slice(0,Math.max(100-o,1)),g=!0}r.push({type:s,str:d}),o+=d.length,g&&(r.push({type:"ellipsis",str:" …"}),o+=2)}}const X={"/":{placeholder:"搜索"}},W=A({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>X}},setup(e){const{locales:t}=I(e),r=b(""),o=b(!1),c=b(-1),i=Y(r),l=C(()=>r.value&&o.value&&i.value.length),n=N(),a=R(),s=C(()=>{var h;return(h=t.value[a.value])!=null?h:{}});function d(){if(!l.value)return;let h=c.value-1;h<0&&(h=i.value.length-1),f(h)}function g(){if(!l.value)return;let h=c.value+1;h>=i.value.length&&(h=0),f(h)}function f(h){c.value=h}function G(){c.value=-1}function D(h){if(!l.value)return;const x=i.value[h];x&&n.push(x.path)}return{query:r,focused:o,focusIndex:c,suggestions:i,activeSuggestion:l,onUp:d,onDown:g,focus:f,unfocus:G,go:D,locale:s}}});const q={class:"search-box",role:"search"},$=["placeholder"],H=["onMousedown","onMouseenter"],Z=["href"],Q={key:0,class:"parent-page-title"},J={class:"suggestion-row"},K={class:"page-title"},ee={class:"suggestion-content"};function te(e,t,r,o,c,i){var l;return u(),p("div",q,[_(m("input",{ref:"input","onUpdate:modelValue":t[0]||(t[0]=n=>e.query=n),"aria-label":"Search",class:S({focused:e.focused}),placeholder:(l=e.locale.placeholder)!=null?l:"Search",autocomplete:"off",spellcheck:"false",onFocus:t[1]||(t[1]=()=>e.focused=!0),onBlur:t[2]||(t[2]=()=>e.focused=!1),onKeyup:[t[3]||(t[3]=y(n=>e.go(e.focusIndex),["enter"])),t[4]||(t[4]=y((...n)=>e.onUp&&e.onUp(...n),["up"])),t[5]||(t[5]=y((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,$),[[O,e.query]]),e.activeSuggestion?(u(),p("ul",{key:0,class:"suggestions",onMouseleave:t[7]||(t[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(u(!0),p(v,null,M(e.suggestions,(n,a)=>(u(),p("li",{key:a,class:S(["suggestion",{focused:a===e.focusIndex}]),onMousedown:s=>e.go(a),onMouseenter:s=>e.focus(a)},[m("a",{href:n.path,onClick:t[6]||(t[6]=F(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[a-1]||e.suggestions[a-1].parentPageTitle!==n.parentPageTitle)?(u(),p("div",Q,w(n.parentPageTitle),1)):L("v-if",!0),m("div",J,[m("div",K,w(n.title||n.path),1),m("div",ee,[(u(!0),p(v,null,M(n.display,(s,d)=>(u(),p("span",{key:d,class:S(s.type)},w(s.str),3))),128))])])],8,Z)],42,H))),128))],32)):L("v-if",!0)])}const ae=E(W,[["render",te],["__scopeId","data-v-fd6cd4d5"],["__file","SearchBox.vue"]]);export{ae as default};
